...
sequences = optimize_sequence(target_tissue, acq_block, prep_modules, total_dur, prep_module_weights=prep_module_weights, min_num_preps=10, N_iter_max=1e6, inversion_efficiency=inversion_efficiency, delta_B1=delta_B1)
